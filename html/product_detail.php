			...
			<table border="0" cellpadding="0" cellspacing="0" width="960">
				<tr>
					<td width="335" align="center" valign="top">
						<!-- 상품이미지 -->
						<table border="0" cellpadding="0" cellspacing="1" width="3" height="315" bgcolor="D4D0C8">
							<tr>
								<td bgcolor="white" align="center">
									<img src="product/<?=$row[image235]?>" height="315" border="0" align="absmiddle" ONCLICK="Zoomimage('<?=$no?>')" STYLE="cursor:hand">
								</td>
							</tr>
						</table>
					</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828"><?=$row[name35]?></font><br>
							...
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td width="289" style="padding-left:10px"><font color="666666"><strike><?=$row[price35]?></strike></font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 판매가 -->
							<tr>
...
?>
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px"><font color="0288DD"><b><?=$price_main?></b></font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 옵션 -->
							<tr>
...
<?
$query = "select * from opts where opt_no35 = $row[opt135]";
$result=mysqli_query($db,$query);
$count=mysqli_num_rows($result); 
if(!$result) exit("쿼리에러 $query"); // 에러 조사
?>
...
for($i = 0; $i < $count; $i++)
  {
	  ...
	  echo("<option value='$row1[no35]'>$row1[name35]</option>");
  }
?>
<?
$query = "select * from opts where opt_no35 = $row[opt235]";
$result=mysqli_query($db,$query);
$count=mysqli_num_rows($result); 
if(!$result) exit("쿼리에러 $query"); // 에러 조사
?>
...
for($i = 0; $i < $count; $i++)
  {
	  ...
	  echo("<option value='$row2[no35]'>$row2[name35]</option>");
  }
?>
									</select>
								</td>
...
?>
				...
				<tr>
					<td height="200" valign=top style="line-height:14pt">
						...
						<br>
						<center>
						<img src="product/<?=$row[image335]?>"><br><br><br>
