...
<?
$query = "select * from sj35 where no35 = $no;";
...
<table width="300" border="1" cellpadding="2" bgcolor="lightblue" style="border-collapse:collapse">
  <tr>
  ...
  <tr>
    ...
    <td width="200">
      <input type="text" name="kor" size="6" value="<?=$row[kor35]?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">영어</td>
    <td width="200">
      <input type="text" name="eng" size="6" value="<?=$row[eng35]?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">수학</td>
    <td width="200">
      <input type="text" name="mat" size="6" value="<?=$row[mat35]?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">총점</td>
    <td width="200">
      <input type="text" name="hap" size="6" value="<?=$row[hap35]?>" readonly style="border:0;background-color:#ffffe0">
    </td>
  </tr>
  <tr>
